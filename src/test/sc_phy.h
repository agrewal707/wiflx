 ...
 */
#ifndef WIFLX_TEST_SC_PHY_H
#define WIFLX_TEST_SC_PHY_H
...
class sc_phy :
  ...
  public common::sc_rx::listener
{
public:
  sc_phy (const common::config::radio &rcfg,
            const common::config::sc &ocfg);
  ~sc_phy ();
...
private:
  ...
  wiflx::common::sc_tx m_sc_tx;
  wiflx::common::sc_rx m_sc_rx;
