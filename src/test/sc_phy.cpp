...
sc_phy::sc_phy (
  ...
  m_sc_rx (ocfg, m_rxbuff, m_radio, this),
  m_sc_tx (ocfg, m_txbuff, m_radio),
  m_stopped (true)
{
...
// TX
//
void sc_phy::send (std::string &&psdu)
{
  WIFLX_LOG_FUNCTION (this);
...
bool sc_phy::wait_on_send (mac_phy::mcs &m, std::string &psdu)
{
  WIFLX_LOG_FUNCTION (this);
