...
#ifndef WIFLX_AP_MAC_PHY_INTERFACE_H
#define WIFLX_AP_MAC_PHY_INTERFACE_H
...
struct sap_user
{
  ...
  virtual void on_send (const size_t bytes_sent) = 0;
};
...
#endif // WIFLX_AP_MAC_PHY_INTERFACE_H
